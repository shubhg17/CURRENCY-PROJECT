...
function useCurrencyInfo(currency) {
   ...
   useEffect(() => {
       ...
       console.log("Currency data fetched for", currency, data)
       // abh final useEffect me joh tumhara fetchAPI ha usse kabh call krvaoge jabh currency me change hoga 
   }, [currency]);

   // isme mene kra kya ki mene ek functionality design kri aur iss pure method ko hi return krdiya useCurrencyInfo wale method ko  jese useState me bhi vohi ho rha ha ki pura ka pura method hi return ho jata ha
   return data;
}
